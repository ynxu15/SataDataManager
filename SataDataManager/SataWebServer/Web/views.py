...
def randomsize(): # to do
    ...
    size = (randomsize.index < 20) and ((50-2*randomsize.index) + random.random() * 8) or (random.random() * 8)
    print(size)
    return str(size)
...
def Persona_single(request):
	...
	data = {
		"dataCloud":[
            {"name": "百度","value": randomsize()},
{"name": "搜索","value": randomsize()},
{"name": "李彦宏","value": randomsize()},
...
{"name": "2015","value": randomsize()},
{"name": "移动","value": randomsize()},
{"name": "AI","value": randomsize()},
{"name": "技术","value": randomsize()},
{"name": "公司","value": randomsize()},
{"name": "产品","value": randomsize()},
{"name": "2018","value": randomsize()},
{"name": "搜索引擎","value": randomsize()},
{"name": "智能","value": randomsize()},
{"name": "平台","value": randomsize()},
{"name": "中国","value": randomsize()},
{"name": "副总裁","value": randomsize()},
{"name": "成立","value": randomsize()},
{"name": "2017","value": randomsize()},
{"name": "2013","value": randomsize()},
{"name": "O2O","value": randomsize()},
{"name": "大厦","value": randomsize()},
{"name": "输入法","value": randomsize()},
{"name": "糯米","value": randomsize()},
{"name": "10","value": randomsize()},
{"name": "梁志祥","value": randomsize()},
{"name": "开发者","value": randomsize()},
{"name": "研发","value": randomsize()},
{"name": "2005","value": randomsize()},
{"name": "2014","value": randomsize()},
{"name": "群组","value": randomsize()},
{"name": "正式","value": randomsize()},
{"name": "手机","value": randomsize()},
{"name": "成为","value": randomsize()},
{"name": "发布","value": randomsize()},
{"name": "美国","value": randomsize()},
{"name": "战略","value": randomsize()},
{"name": "中文","value": randomsize()},
{"name": "应用","value": randomsize()},
{"name": "张亚勤","value": randomsize()},
{"name": "2011","value": randomsize()},
{"name": "2016","value": randomsize()},
{"name": "营收","value": randomsize()},
{"name": "开放平台","value": randomsize()},
{"name": "简单","value": randomsize()},
{"name": "合作","value": randomsize()},
{"name": "刘辉","value": randomsize()},
{"name": "微软","value": randomsize()},
{"name": "王路","value": randomsize()},
{"name": "海峰","value": randomsize()},
{"name": "企业","value": randomsize()},
{"name": "数据","value": randomsize()},
{"name": "海龙","value": randomsize()},
{"name": "2000","value": randomsize()},
{"name": "App","value": randomsize()},
{"name": "小度","value": randomsize()},
{"name": "DU","value": randomsize()},
{"name": "发展","value": randomsize()},
{"name": "上线","value": randomsize()},
{"name": "业务","value": randomsize()},
{"name": "领域","value": randomsize()},
{"name": "最大","value": randomsize()},
{"name": "创新","value": randomsize()},
{"name": "驾驶","value": randomsize()},
{"name": "开放","value": randomsize()},
{"name": "约合","value": randomsize()},
{"name": "世界","value": randomsize()},
{"name": "推出","value": randomsize()},
{"name": "收购","value": randomsize()},
{"name": "品牌","value": randomsize()},
{"name": "2004","value": randomsize()},
{"name": "2007","value": randomsize()},
{"name": "12","value": randomsize()},
{"name": "自动","value": randomsize()},
{"name": "百科","value": randomsize()},
{"name": "亿美元","value": randomsize()},
{"name": "加盟","value": randomsize()},
{"name": "语音","value": randomsize()},
{"name": "人民币","value": randomsize()},
{"name": "巴西","value": randomsize()},
{"name": "深度","value": randomsize()},
{"name": "最具","value": randomsize()},
{"name": "创建","value": randomsize()},
{"name": "地图","value": randomsize()},
{"name": "分公司","value": randomsize()},
{"name": "运营","value": randomsize()},
{"name": "联盟","value": randomsize()},
{"name": "推广","value": randomsize()},
{"name": "首个","value": randomsize()},
{"name": "国际化","value": randomsize()},
{"name": "技术创新","value": randomsize()},
{"name": "提供","value": randomsize()},
{"name": "余正钧","value": randomsize()},
{"name": "2006","value": randomsize()},
{"name": "PC","value": randomsize()},
{"name": "CEO","value": randomsize()},
{"name": "11","value": randomsize()},
...
def profilebasicinfo(request):
    return Persona_single(request)
def profiledevelop(request):
    return render(request, 'profiledevelop.html')
def profilerisk(request):
    return render(request, 'profilerisk.html')
def profileinno(request):
    return render(request, 'profileinno.html')
# def Persona(request):
#     	randomsize.index = 0
#     	a1=8.6
#     	a2=4.7
