...
urlpatterns = [
    ...
    url('govPolicyMacroTime.html$', govPolicyView.govPolicyTimeView),
    url('govPolicyMacroBusiness', govPolicyView.govPolicyBusinessView),
    url('govPolicyMicroCom.html$', govPolicyView.govPolicyComView),
    ...
    url(r'govPolicyMacroRegion/comIncom$', govPolicyView.govPolicyRegionComIncom),
    url(r'govPolicyMacroRegion/comIncrease$', govPolicyView.govPolicyRegionComIncrease),
    url('govPolicyMicroCom/comInfo$', govPolicyView.govPolicyComInfo),
    url('govPolicyMicroCom/comFinance$', govPolicyView.govPolicyComFinance),
    url('govPolicyMacroTime/regionInfoQuery$', govPolicyView.govPolicyTimeRegionInfoQuery),
    url('govPolicyMacroTime/regionInfoCompare$', govPolicyView.govPolicyTimeRegionInfoCompare),
]
